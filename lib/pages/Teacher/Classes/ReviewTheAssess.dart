...
class ReviewAssessment extends StatefulWidget {
  ...
  const ReviewAssessment({Key? key, required this.passedAssessmentIdName})
      : super(key: key);
  @override
  _ReviewAssessmentState createState() => _ReviewAssessmentState();
}

class _ReviewAssessmentState extends State<ReviewAssessment> {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<DocumentSnapshot>(
        ...
        builder:
          ...
          // Fetch all the Competences (not much anyway)
          return StreamBuilder<QuerySnapshot>(
              ...
              builder:
                ...
                // Checks if the student is already assessed.
                studs.forEach((key, value) {
                  if (value == true) studsToAssess.add(key);
                });
