...
class GenSingleSelfAssessment extends StatefulWidget {
  ...
  const GenSingleSelfAssessment(this.passedClassName, this.passedName,
      this.passedCompetences, this.passedStudName);

  @override
  _GenSingleSelfAssessmentState createState() =>
      _GenSingleSelfAssessmentState();
}

class _GenSingleSelfAssessmentState extends State<GenSingleSelfAssessment> {
