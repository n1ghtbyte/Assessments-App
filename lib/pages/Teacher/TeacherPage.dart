...
class _TeacherPageState extends State<TeacherPage> {
  final Query _classesStream = FirebaseFirestore.instance
    ...
    Future<String> getImage() async {
      final storage = FirebaseStorage.instanceFor(
        bucket:"//assessments-app-o3.appspot.com");
      String t = await storage
        .ref()
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(future: getImage(),
          ...
          return StreamBuilder<QuerySnapshot>(
              ...
              builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                ...
                if (snapshot.data?.size.toInt() == 0) {
                    return MaterialApp(
                      home: Scaffold(
                          drawer: NavBarTeacher(text.data),
                          appBar: AppBar(
