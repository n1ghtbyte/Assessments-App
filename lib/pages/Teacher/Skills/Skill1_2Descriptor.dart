...
class Skill1_2Descriptor extends StatefulWidget {
  const Skill1_2Descriptor({Key? key}) : super(key: key);

  @override
  _Skill1_2DescriptorState createState() => _Skill1_2DescriptorState();
}

class _Skill1_2DescriptorState extends State<Skill1_2Descriptor> {
  @override
